...
export default function Dashboard() {
  ...
  // Pick up key + login from OAuth redirect (?key=...&login=...)
  useEffect(() => {
  ...
  return (
    <main>
      ...
      <div className="mx-auto max-w-5xl px-6 py-16 md:px-12">
        ...
        {/* New key banner — shown once after OAuth redirect */}
        <AnimatePresence>
          {newKey && (
            <motion.div
            ...
            >
              ...
              <p className="text-xs text-text-secondary mb-4 leading-relaxed">
                Copy this now. For security we won't show it again — but you can always sign in again to retrieve it.
              </p>
            ...
            <div className="border border-border bg-surface p-6">
              ...
              <p className="text-2xl font-semibold text-text-primary tabular-nums">
                ...
                <span className="text-text-tertiary text-base font-normal">
                  {' '}/ {usage.requests.limit === 2147483647 ? '∞' : usage.requests.limit}
                </span>
              </p>
